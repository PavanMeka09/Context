...
import { MessageSquare, Plus, Settings as SettingsIcon, Trash2, PanelLeftClose, Search, Sun, Moon, Clock, Compass } from 'lucide-react';
        ...
        <div className="flex items-center gap-1 shrink-0">
          {onOpenBrowserModal && (
            <button
              ...
              title="Open Browser Sandbox (Large Screen)"
